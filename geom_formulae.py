...
>>> triangle_area(3,4)
    ...
    @param angle_alpha: The the angle between any two sides of the triangle
    ...
    if (side_a is not None) & (height is not None):
        ...
        return area
            ...
            area = 0.5*side_a*side_b*sin(angle_alpha)
            return area
...
print("Volume of cylinder  ", cylinder_volume(2, 4))
